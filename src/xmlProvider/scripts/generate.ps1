...
GenerateObject "INMBP" "xsd/DEF_GWM/GWM-schedule-xml.xsd xsd/DEF_GWM/GWM-etso-core-cmpts.xsd xsd/DEF_GWM/GWM-etso-code-lists.xsd xsd/DEF_GWM/GWM-etso-core-cmpts.xsd xsd/DEF_GWM/GWM-anomaly-xml.xsd xsd/DEF_GWM/GWM-confirmation-xml.xsd xsd/DEF_GWM/GWM-acknowledgement-xml.xsd"
